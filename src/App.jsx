...
function App() {
  ...
  const [accountBalance] = useState(70000) // Change the Actual Balance from the account (in cents)
  const [paymentAmount] = useState(802492) // Change the Payment Amount from the request (in cents)
  const [dueDate] = useState('2025-12-25') // Change the Due date in YYYY-MM-DD format from the request
